...
- Triage Java annotation retention, targets, reflection lookup, repeatable/type-use annotations, processors, and predefined annotations with `java-tutor/scripts/java_annotations_triage.py`.
